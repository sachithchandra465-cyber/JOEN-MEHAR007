...
cmd({
  ...
  try {
    ...
    const rawVersionUrl = 'https://raw.githubusercontent.com/ANAYAT-AI/ANAYAT-AI/main/data/version.json';
...
Use *.update* to update.`;
    ...
    const statusMessage = `🌟 *Good ${new Date().getHours() < 12 ? 'Morning' : 'Night'}, ${pushname}!* 🌟\n\n` +
      ...
      `📝 *Changelog:*\n${latestChangelog}\n\n` +
      `⭐ *GitHub Repo:* ${githubRepo}\n👤 *Owner:* [JOEN-MEHAR007](https://github.com/ANAYAT-AI/ANAYAT-AI/tree/main)\n\n${updateMessage}\n\n🚀 *Hey! Don't forget to fork & star the repo!*`;
